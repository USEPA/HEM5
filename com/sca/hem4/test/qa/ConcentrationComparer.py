...
class ConcentrationComparer(ExcelWriter):
    ...
    def __init__(self, fac_id, source_id, pollutant, hapemisPath, output_dir):
        ...
        filename = fac_id + "_concentrations_compared.xlsx"
    ...
    def getHeader(self):
        ...
        return ['Facility ID', 'Source ID', 'Pollutant', 'Receptor Type',
                'Lat', 'Lon', 'UTME', 'UTMN', 'Retrieved Conc', 'Computed Conc', '% Change']

    def getColumns(self):
        return [fac_id, source_id, pollutant, rec_type, lat, lon, utme, utmn, 'r_conc', 'c_conc', 'change']
