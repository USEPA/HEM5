...
class AcuteChemicalPopulated(ExcelWriter, InputFile):
    ...
    def getHeader(self):
        ...
        header_names = (['Pollutant', 'Conc (µg/m3)', 'Conc sci (µg/m3)'] + bench_names +
                 ...
                 'Elevation (in meters)', 'Hill Height (in meters)', 'Fips', 'Block', 
        ...
        try:
            ...
            for index, row in acute_df.iterrows():
                if row[notes].split(" ")[0] == 'Interpolated':
                    ...
                    acute_df.at[index,distance] = 0.0
                    acute_df.at[index,angle] = 0.0
                    acute_df.at[index,utmn] = 0.0
                    acute_df.at[index,utme] = 0.0
