...
class HEMdash():
    ...
    def __init__(self, dirtouse):
        ...
        for item in DoseResponse.getAcuteNames():
            ...
            self.bench_names.append(bench_item)
    ...
    #            df_max_HI['Facility ID']= df_max_HI['Facility ID'] = 'F' + df_max_HI['Facility ID'].astype(str)
                ...
                try:
                    ...
                    df_acute.columns = ['Facility', 'Pollutant', self.bench_names[4]
                                        , self.bench_names[0], self.bench_names[2]
                                        , self.bench_names[1], self.bench_names[3]]
                ...
                OrRd = ['#fee5d9', '#fcae91', '#fb6a4a', '#de2d26', '#a50f15'],
                ...
                facramps = {'OrRd':OrRd, 'PuBu':PuBu, 'BuPu':BuPu, 'Oranges':Oranges, 'BuGn':BuGn,
                            'YlOrBr':YlOrBr, 'YlGn':YlGn, 'Reds':Reds, 'RdPu':RdPu, 'Greens':Greens,
                            'YlGnBu':YlGnBu, 'Purples':Purples, 'GnBu':GnBu, 'Greys':Greys,
                            'YlOrRd':YlOrRd, 'PuRd':PuRd, 'Blues':Blues, 'PuBuGn':PuBuGn,
                            'Viridis':Viridis}
