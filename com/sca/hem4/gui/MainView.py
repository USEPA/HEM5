...
class MainView(tk.Frame):
    def __init__(self, master, *args, **kwargs):
        ...
        oinew = self.add_margin(oi, 3, 0, 3, 0)
        ...
        # EJ nav button
        self.ejLabel= tk.Label(self, text="ENVIRONMENTAL JUSTICE", font=TAB_FONT, bg=self.main_color, height=2, pady=2, anchor="w")
        self.ejLabel.place(in_=self.container, relwidth=0.2, rely=0.36, relx=0.1)
        ...
        self.outputLabel = tk.Label(self, image=ejIcon, bg=self.main_color)
        self.outputLabel.image = ejIcon # keep a reference!
        self.outputLabel.place(in_=self.container, relwidth=0.1, rely=0.36)

        # bind icon and label events
        self.ejLabel.bind("<Enter>", partial(self.color_config, self.ejLabel, self.outputLabel, self.highlightcolor))
        self.ejLabel.bind("<Leave>", partial(self.color_config, self.ejLabel, self.outputLabel,self.main_color))
        self.ejLabel.bind("<Button-1>", partial(self.lift_page, self.ejLabel, self.outputLabel, self.analyze, self.current_button))

        self.outputLabel.bind("<Enter>", partial(self.color_config, self.outputLabel, self.ejLabel, self.highlightcolor))
        self.outputLabel.bind("<Leave>", partial(self.color_config, self.outputLabel, self.ejLabel,self.main_color))
        self.outputLabel.bind("<Button-1>", partial(self.lift_page, self.outputLabel, self.ejLabel, self.analyze, self.current_button))
