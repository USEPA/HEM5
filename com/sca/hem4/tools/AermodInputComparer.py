...
class AermodInputComparer:
    ...
    def compare(self):
        ...
        hem3File = os.path.join(self.pathToFiles, "aermod_hem3.inp")
        ...
        hem4File = os.path.join(self.pathToFiles, "aermod_hem4.inp")
        ...
        diffFile = os.path.join(self.pathToFiles, "diff.txt")
