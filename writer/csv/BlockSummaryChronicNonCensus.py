...
class BlockSummaryChronicNonCensus(CsvWriter):
    ...
    def calculateOutputs(self):
        ...
        self.headers = ['Latitude', 'Longitude', 'Overlap', 'Elevation (m)', 'Receptor ID', 'X', 'Y', 'Hill',
        ...
        self.dataframe = inneragg.append(outeragg, ignore_index = True).sort_values(by=[rec_id])
