...
class AllOuterReceptorsNonCensus(CsvWriter):
    ...
    def calculateOutputs(self):
        ...
        self.headers = ['Receptor ID', 'Latitude', 'Longitude', 'Source ID', 'Emission type', 'Pollutant',
        ...
        dlist = []
        columns = [rec_id, lat, lon, source_id, ems_type, pollutant, conc, aconc, elev, population, overlap]
