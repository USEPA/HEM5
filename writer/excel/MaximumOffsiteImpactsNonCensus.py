...
class MaximumOffsiteImpactsNonCensus(ExcelWriter):
    ...
    def getHeader(self):
        return ['Parameter', 'Value', 'Value_rnd', 'Value_sci', 'Population', 'Distance (in meters)',
                'Angle (from north)', 'Elevation (in meters)', 'Hill Height (in meters)', 'Receptor ID',
    ...
    def generateOutputs(self):
        ...
        rectype_dict = {"P":"Polar grid", "I":"User"}
        ...
        for parm in parmdict:
            ...
            if moi_value > 0:
                ...
                moi_recid = allrisk[rec_id].loc[io_idx]
            ...
            moi_row = [moi_parm, moi_value, moi_value_rnd, moi_value_sci, moi_pop, moi_dist, moi_angle,
                       moi_elev, moi_hill, moi_recid, moi_utme, moi_utmn,
